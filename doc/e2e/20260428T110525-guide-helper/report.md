...
Дата запуска: 28.04.2026, 14:06:23

Стенд: https://guidehelper.dubrovskih.ru

Тестовый пользователь: e2e-20260428T110525@guide-helper.local
...
|---|---|---|---|
| Auth | регистрация нового пользователя | PASS | e2e-20260428T110525@guide-helper.local |
| Auth | вход зарегистрированного пользователя | PASS | получены access/refresh token |
| Profile | обновление профиля | PASS | E2E пользователь 20260428T110525 |
| Profile | смена пароля и повторный вход | PASS | новый пароль принят |
| Catalog | получение категорий | PASS | 5 categories |
| Routes | создание маршрута с точками, заметками и кастомизацией | PASS | 44bb4706-f952-4dbe-8999-e31521ba083b |
| Routes | обновление маршрута | PASS | E2E маршрут 20260428T110525 обновлён |
| Routes | импорт GeoJSON | PASS | 4 points |
| Share | публикация маршрута | PASS | 11ef0ae2-5092-4a16-92c6-73b1c9e69ac1 |
| Share | публичное получение маршрута | PASS | E2E маршрут 20260428T110525 обновлён |
| Social | создание комментария | PASS | ad55d728-bd7d-4678-8154-89522ddc77d1 |
...
| Admin | статистика и списки | PASS | users=57, routes=181, comments=167 |
| Admin | CRUD категории | PASS | caf826cb-6ced-4b1e-882e-391c4a933a9a |
...
| Cleanup | удаление импортированного маршрута | PASS | 1010e74d-e52a-497a-b01b-0a8cb519099f |
| Cleanup | удаление основного e2e-маршрута | PASS | 44bb4706-f952-4dbe-8999-e31521ba083b |
...
- Основной маршрут: 44bb4706-f952-4dbe-8999-e31521ba083b (удалён cleanup-шагом)
- Share token: 11ef0ae2-5092-4a16-92c6-73b1c9e69ac1
- Комментарий: ad55d728-bd7d-4678-8154-89522ddc77d1
- Импортированный маршрут: 1010e74d-e52a-497a-b01b-0a8cb519099f (удалён cleanup-шагом)
